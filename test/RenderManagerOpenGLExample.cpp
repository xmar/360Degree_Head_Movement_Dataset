...
void SetupEye(
    ...
    glViewport(static_cast<GLint>(viewport.left),
      ...
      std::cout << ++counter << " Eye: " << whichEye << " " << viewport.left << " " << viewport.lower << " " << viewport.width << " " << viewport.height <<
        " mat: " << projectionToUse.nearClip << "; "  << projectionToUse.farClip << "; "  << projectionToUse.right << "; "  << projectionToUse.left << "; "  << std::endl;
...
void DrawWorld(
    ...
    std::cout << ++counter  << " Draw world" << std::endl;
...
// Set up a handler to cause us to exit cleanly.
    ...
    // Configure the near and far clipping planes, in case we don't like
    // the defaults.
    osvr::renderkit::RenderManager::RenderParams params;
    params.nearClipDistanceMeters = 0.05;
    params.farClipDistanceMeters = 30.0;
